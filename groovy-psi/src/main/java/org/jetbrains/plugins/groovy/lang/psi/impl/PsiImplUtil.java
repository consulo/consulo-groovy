...
public class PsiImplUtil
{
	...
	{
		final PsiElement newNameElement = GroovyPsiElementFactory.getInstance(nameElement.getProject())
	...
	@Nullable
	private static PsiType doNormalizeWildcardByPosition(final PsiType type,
			final GrExpression expression,
			final GrExpression toplevel)
	{
	...
	public static boolean hasElementType(@Nullable PsiElement next, @Nonnull final IElementType type)
	{
		if(next == null)
		{
			return false;
	...
	public static boolean hasElementType(@javax.annotation.Nullable PsiElement next, final TokenSet set)
	{
		if(next == null)
		{
			return false;
	...
	public static boolean hasNamedArguments(@javax.annotation.Nullable GrNamedArgumentsOwner list)
	{
		if(list == null)
		{
			return false;
	...
	public static GrNamedArgument findNamedArgument(final GrNamedArgumentsOwner namedArgumentOwner, String label)
	{
	...
	public static boolean isWhiteSpaceOrNls(@javax.annotation.Nullable ASTNode node)
	{
			...
			final Class<T> klass)
	{
		...
		final T element = ReflectionUtil.isAssignable(klass, commonParent.getClass()) ? (T) commonParent : PsiTreeUtil
	...
	public static boolean isSpreadAssignment(@javax.annotation.Nullable GrExpression lValue)
	{
			...
			GrReflectedMethod reflectedMethod)
	{
		...
		return new GroovyResolveResultImpl(baseMethod, result.getCurrentFileResolveContext(), result.getSpreadState(), substitutor, result.isAccessible(), result.isStaticsOK(), result.isInvokedOnProperty(), result.isValidResult());
	}
}
