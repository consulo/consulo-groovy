...
public class GrClosureSignatureUtil {
  ...
  public static GrClosureSignature createSignature(GrCall call) {
    if (call instanceof GrMethodCall) {
      ...
      if (type instanceof GrClosureType) {
        ...
        Trinity<GrClosureSignature, ArgInfo<PsiType>[], ApplicabilityResult> trinity =
  ...
  public static GrClosureSignature removeParam(GrClosureSignature signature, int i) {
    GrClosureParameter[] newParams = ArrayUtil.remove(signature.getParameters(), i);
  ...
  @Nonnull
  public static GrClosureSignature rawSignature(@Nonnull GrClosureSignature signature) {
    GrClosureParameter[] params = signature.getParameters();

    GrClosureParameter[] closureParams = ContainerUtil.map(params, parameter -> {
  ...
  @Nullable
  public static PsiType getReturnType(@Nonnull GrSignature signature, @Nonnull GrMethodCall expr) {
    return getReturnType(signature, PsiUtil.getArgumentTypes(expr.getInvokedExpression(), true), expr);
  }

  @Nullable
  public static PsiType getReturnType(@Nonnull final GrSignature signature, @Nullable PsiType[] args, @Nonnull GroovyPsiElement context) {
  ...
  public static boolean isSignatureApplicable(@Nonnull GrSignature signature, @Nonnull PsiType[] args, @Nonnull PsiElement context) {
    return isSignatureApplicableConcrete(signature, args, context) != ApplicabilityResult.inapplicable;
  }

  public static ApplicabilityResult isSignatureApplicableConcrete(@Nonnull GrSignature signature,
                                                                  @Nonnull PsiType[] args,
                                                                  @Nonnull PsiElement context) {
    List<Trinity<GrClosureSignature, ArgInfo<PsiType>[], ApplicabilityResult>> results =
      getSignatureApplicabilities(signature, args, context);
  ...
  @Nullable
  public static Trinity<GrClosureSignature, ArgInfo<PsiType>[], ApplicabilityResult> getApplicableSignature(@Nonnull GrSignature signature,
  ...
  private static List<Trinity<GrClosureSignature, ArgInfo<PsiType>[], ApplicabilityResult>> getSignatureApplicabilities(@Nonnull GrSignature signature,
    ...
    signature.accept(new GrRecursiveSignatureVisitor() {
      ...
      public void visitClosureSignature(GrClosureSignature signature) {
        ...
        if (map != null) {
          results.add(new Trinity<GrClosureSignature, ArgInfo<PsiType>[], ApplicabilityResult>(signature,
                                                                                               map,
                                                                                               isSignatureApplicableInner(map, signature)));
          return;
        }
  ...
  private static ApplicabilityResult isSignatureApplicableInner(@Nonnull ArgInfo<PsiType>[] infos, @Nonnull GrClosureSignature signature) {
    GrClosureParameter[] parameters = signature.getParameters();
  ...
  public static boolean isVarArgsImpl(@Nonnull GrClosureParameter[] parameters) {
  ...
  @Nullable
  public static ArgInfo<PsiType>[] mapArgTypesToParameters(@Nonnull GrClosureSignature signature,
                                                           @Nonnull PsiType[] args,
                                                           @Nonnull PsiElement context,
                                                           boolean partial) {
    return mapParametersToArguments(signature, args, Function.identity(), context, partial);
  }
  ...
  @Nullable
  private static <Arg> ArgInfo<Arg>[] mapParametersToArguments(@Nonnull GrClosureSignature signature,
                                                               @Nonnull Arg[] args,
                                                               @Nonnull Function<Arg, PsiType> typeComputer,
                                                               @Nonnull PsiElement context,
                                                               boolean partial) {
    ...
    ArgInfo<Arg>[] map = mapSimple(params, args, typeComputer, context, false);
  ...
  private static boolean checkForOnlyMapParam(@Nonnull GrClosureSignature signature, int argCount) {
  ...
  @Nullable
  private static <Arg> ArgInfo<Arg>[] mapSimple(@Nonnull GrClosureParameter[] params,
                                                @Nonnull Arg[] args,
                                                @Nonnull Function<Arg, PsiType> typeComputer,
                                                @Nonnull PsiElement context,
                                                boolean partial) {
    ...
    for (int i = 0; i < args.length; i++, cur++) {
      ...
      PsiType type = typeComputer.apply(args[i]);
  ...
  private static boolean isAssignableByConversion(@Nullable PsiType paramType, @Nullable PsiType argType, @Nonnull PsiElement context) {
  ...
  public static void checkAndAddSignature(List<GrClosureSignature> list,
    ...
    for (int i = position; i < last; i++) {
      GrClosureParameter p = params.get(i);
    ...
    list.add(new GrImmediateClosureSignatureImpl(_p,
                                                 returnType,
  ...
  private static class ParameterMapperForVararg<Arg> {
    ...
    private ParameterMapperForVararg(PsiElement context,
      ...
      for (int i = 0; i < args.length; i++) {
        types[i] = typeComputer.apply(args[i]);
      }
  ...
  @Nullable
  public static Map<GrExpression, Pair<PsiParameter, PsiType>> mapArgumentsToParameters(@Nonnull GroovyResolveResult resolveResult,
                                                                                        @Nonnull PsiElement context,
                                                                                        boolean partial,
                                                                                        boolean eraseArgs,
                                                                                        @Nonnull GrNamedArgument[] namedArgs,
                                                                                        @Nonnull GrExpression[] expressionArgs,
    ...
    ArgInfo<PsiElement>[] argInfos =
      mapParametersToArguments(signature, namedArgs, expressionArgs, closureArguments, context, partial, eraseArgs);
    if (argInfos == null) {
      return null;
    }
  ...
  @Nullable
  public static ArgInfo<PsiElement>[] mapParametersToArguments(@Nonnull GrClosureSignature signature, @Nonnull GrCall call) {
  ...
  @Nullable
  public static ArgInfo<PsiElement>[] mapParametersToArguments(@Nonnull GrClosureSignature signature,
                                                               @Nonnull GrNamedArgument[] namedArgs,
                                                               @Nonnull GrExpression[] expressionArgs,
                                                               @Nonnull GrClosableBlock[] closureArguments,
                                                               @Nonnull PsiElement context,
    ...
    for (GrExpression expression : expressionArgs) {
      ...
      if (partial && expression instanceof GrNewExpression && com.intellij.java.language.psi.util.PsiUtil.resolveClassInType(type) == null) {
        type = null;
      }
      if (eraseArgs) {
  ...
  private static ArgInfo<PsiElement>[] mapParametersToArguments(@Nonnull GrClosureSignature signature,
                                                                @Nonnull List<InnerArg> innerArgs,
                                                                boolean hasNamedArgs,
                                                                boolean partial,
                                                                @Nonnull PsiElement context) {
    ArgInfo<InnerArg>[] innerMap =
      mapParametersToArguments(signature, innerArgs.toArray(new InnerArg[innerArgs.size()]), o -> o.type, context, partial);
  ...
  @Nonnull
  public static MultiMap<MethodSignature, PsiMethod> findRawMethodSignatures(@Nonnull PsiMethod[] methods, @Nonnull PsiClass clazz) {
  ...
  @Nonnull
  private static PsiSubstitutor calcRawSubstitutor(@Nonnull Map<PsiTypeParameter, PsiType> initialMap,
                                                   @Nonnull PsiSubstitutor initialSubstitutor,
                                                   @Nonnull PsiMethod actual) {
    if (actual.hasTypeParameters()) {
      HashMap<PsiTypeParameter, PsiType> map1 = new HashMap<>(initialMap);
  ...
  private static MethodSignature generateSignature(String name,
    ...
    return MethodSignatureUtil.createMethodSignature(name,
                                                     paramTypes.toArray(PsiType.createArray(paramTypes.size())),
                                                     typeParameters,
                                                     substitutor);
  }

  public static void generateAllMethodSignaturesByClosureSignature(@Nonnull String name,
  ...
  public static List<MethodSignature> generateAllMethodSignaturesBySignature(@Nonnull final String name,
                                                                             @Nonnull GrSignature signature) {
  ...
  @Nullable
  public static <Arg> MapResultWithError<Arg> mapSimpleSignatureWithErrors(@Nonnull GrClosureSignature signature,
                                                                           @Nonnull Arg[] args,
                                                                           @Nonnull Function<Arg, PsiType> typeComputer,
                                                                           @Nonnull GroovyPsiElement context,
                                                                           int maxErrorCount) {
    ...
    for (int i = 0; i < params.length; i++) {
      ...
      if (isAssignableByConversion(params[i].getType(), type, context)) {
        ...
        for (int j = i; j < args.length; j++) {
          if (!isAssignableByConversion(ellipsis, typeComputer.apply(args[j]), context)) {
            errorCount++;
  ...
  public static List<GrClosureSignature> generateSimpleSignatures(@Nonnull GrSignature signature) {
    final List<GrClosureSignature> result = new ArrayList<GrClosureSignature>();
    signature.accept(new GrRecursiveSignatureVisitor() {
      @Override
      public void visitClosureSignature(GrClosureSignature signature) {
        GrClosureParameter[] original = signature.getParameters();
        ArrayList<GrClosureParameter> parameters = new ArrayList<GrClosureParameter>(original.length);
        ...
        int pcount = signature.isVarargs() ? signature.getParameterCount() - 2 : signature.getParameterCount() - 1;
        for (int i = pcount; i >= 0; i--) {
          if (original[i].isOptional()) {
            result.add(new GrImmediateClosureSignatureImpl(parameters.toArray(new GrClosureParameter[parameters.size()]),
