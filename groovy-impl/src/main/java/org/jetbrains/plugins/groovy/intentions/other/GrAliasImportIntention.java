...
public class GrAliasImportIntention extends Intention {
  ...
  private static void runTemplate(Project project,
    ...
    consulo.language.editor.impl.internal.template.TemplateBuilderImpl templateBuilder =
      new consulo.language.editor.impl.internal.template.TemplateBuilderImpl(templateImport);
