...
public class ConvertStringToMultilineIntention extends Intention {
    ...
    public static final LocalizeValue hint = GroovyIntentionLocalize.convertStringToMultilineIntentionName();

    @Nonnull
    @Override
    public LocalizeValue getText() {
        return GroovyIntentionLocalize.convertStringToMultilineIntentionName();
    }
    ...
    private static List<GrExpression> collectExpressions(@Nonnull PsiElement element) {
        ...
        while (element.getParent() instanceof GrBinaryExpression) {
            ...
            if (!isAppropriateBinary(binary, element)) {
                break;
            }
