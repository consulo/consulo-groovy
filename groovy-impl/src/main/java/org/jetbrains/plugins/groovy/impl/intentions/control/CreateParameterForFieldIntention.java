...
public class CreateParameterForFieldIntention extends Intention {
    private static final Logger LOG =
        Logger.getInstance("org.jetbrains.plugins.groovy.intentions.control.CreateParameterForFieldIntention");
    private static final Key<CachedValue<List<GrField>>> FIELD_CANDIDATES = Key.create("Fields.candidates");

    @Nonnull
    @Override
    public LocalizeValue getText() {
        return GroovyIntentionLocalize.createParameterForFieldIntentionName();
    }
