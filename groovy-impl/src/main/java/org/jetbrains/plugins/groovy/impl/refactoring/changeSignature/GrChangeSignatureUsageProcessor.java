  ...
  private static boolean processPrimaryMethodInner(JavaChangeInfo changeInfo, GrMethod method, @Nullable PsiMethod baseMethod) {
    ...
    for (JavaParameterInfo newParameter : newParameters) {
      ...
      GrParameter grParameter =
        factory.createParameter(newName, type == null ? null : type.getCanonicalText(), getInitializer(newParameter),
                                parameterList);
        ...
        if (index >= 0) {
          ...
          try {
            ...
            if (i > 0 && (value == null || anchor == null)) {
              PsiElement comma = Factory.createSingleLeafElement(GroovyTokenTypes.mCOMMA,
                                                                 ",",
                                                                 0,
                                                                 1,
