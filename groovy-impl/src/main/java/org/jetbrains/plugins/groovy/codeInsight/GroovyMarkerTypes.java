...
public class GroovyMarkerTypes
{
	...
	}, new LineMarkerNavigator()
	{
		...
		public void browse(MouseEvent e, PsiElement element)
		{
			...
			PsiElementListNavigator.openTargets(e, supers, DaemonBundle.message("navigation.title.super.method", field.getName()), DaemonBundle.message("navigation.findUsages.title.super.method",
	...
	}, new LineMarkerNavigator()
	{
		...
		public void browse(MouseEvent e, PsiElement element)
		{
			...
			final CommonProcessors.CollectProcessor<PsiMethod> collectProcessor = new CommonProcessors.CollectProcessor<PsiMethod>(new HashSet<PsiMethod>());
	...
	}, new LineMarkerNavigator()
	{
		...
		public void browse(MouseEvent e, PsiElement element)
		{
			...
			PsiElementListNavigator.openTargets(e, superMethods.toArray(new NavigatablePsiElement[superMethods.size()]), DaemonBundle.message("navigation.title.super.method", method.getName()),
					DaemonBundle.message("navigation.findUsages.title.super.method", method.getName()), new MethodCellRenderer(true));
	...
	}, new LineMarkerNavigator()
	{
		...
		public void browse(MouseEvent e, PsiElement element)
		{
			...
			final PsiElementProcessor.CollectElementsWithLimit<PsiMethod> collectProcessor = new PsiElementProcessor.CollectElementsWithLimit<PsiMethod>(2, new HashSet<PsiMethod>());
			if(!ProgressManager.getInstance().runProcessWithProgressSynchronously(new Runnable()
			{
				@Override
				public void run()
	...
	private static class OverridingMethodsUpdater extends ListBackgroundUpdaterTask
	{
		...
		{
			return myMethod.hasModifierProperty(PsiModifier.ABSTRACT) ? DaemonBundle.message("navigation.title.implementation.method", myMethod.getName(),
					size) : DaemonBundle.message("navigation.title.overrider.method", myMethod.getName(), size);
		}
