...
public class UnusedDefInspection extends GroovyLocalInspectionBase {
    ...
    public LocalizeValue getDisplayName() {
        return GroovyInspectionLocalize.unusedAssignment();
    }
        ...
        owner.accept(new GroovyRecursiveElementVisitor() {
            ...
            public void visitVariable(GrVariable variable) {
                ...
                if (ReferencesSearch.search(variable).findFirst() == null) {
                    process(variable, checked, problemsHolder, GroovyInspectionLocalize.unusedVariable().get());
                }
            }
        });
    }
        ...
        if (var != null) {
            ...
            if (scope == null) {
                ...
                if (file == null) {
                    ...
                    LOG.error(
                        "var: " + var.getName() + ", offset:" + (range != null ? range.getStartOffset() : -1),
