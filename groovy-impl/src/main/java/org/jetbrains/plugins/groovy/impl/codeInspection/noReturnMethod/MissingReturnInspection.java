...
public class MissingReturnInspection extends GroovySuppressableInspectionTool {
    ...
    public LocalizeValue[] getGroupPath() {
        return new LocalizeValue[]{
            GroovyLocalize.groovy(),
            getGroupDisplayName()
        };
    }
    ...
    public LocalizeValue getDisplayName() {
        return GroovyInspectionLocalize.noReturnDisplayName();
    }
    ...
    public static boolean methodMissesSomeReturns(
        @Nonnull GrControlFlowOwner block,
