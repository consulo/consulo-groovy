...
public class GroovyIndentProcessor extends GroovyElementVisitor
{
	...
	private static final TokenSet GSTRING_TOKENS_INNER = TokenSet.create(GroovyTokenTypes.mGSTRING_CONTENT,
			GroovyTokenTypes.mGSTRING_END, GroovyTokenTypes.mDOLLAR);
	...
	public void visitLabeledStatement(GrLabeledStatement labeledStatement)
	{
		...
		{
			CommonCodeStyleSettings.IndentOptions indentOptions = myBlock.getContext().getSettings()
					.getIndentOptions();
	...
	public void visitMethod(GrMethod method)
	{
		...
		{
			myResult = getGroovySettings().ALIGN_THROWS_KEYWORD ? Indent.getNoneIndent() : Indent
