...
public class GroovyGenerateMethodMissingHandler extends GenerateMembersHandlerBase {
    ...
    protected List<? extends GenerationInfo> generateMemberPrototypes(PsiClass aClass, ClassMember[] members)
        ...
        GrMethod method = genMethod(aClass, template);
        return method != null
    ...
    protected ClassMember[] chooseOriginalMembers(PsiClass aClass, Project project) {
        ...
        if (method != null) {
            LocalizeValue text = GroovyCodeInsightLocalize.generateMethodMissingAlreadyDefinedWarning();

            if (Messages.showYesNoDialog(
                project,
                text.get(),
                GroovyCodeInsightLocalize.generateMethodMissingAlreadyDefinedTitle().get(),
