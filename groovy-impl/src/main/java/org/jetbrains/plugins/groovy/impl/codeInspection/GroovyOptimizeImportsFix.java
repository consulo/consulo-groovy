...
public class GroovyOptimizeImportsFix implements SyntheticIntentionAction {
    private static final Logger LOG =
        Logger.getInstance("#org.jetbrains.plugins.groovy.codeInspection.local.GroovyPostHighlightingPass");
    ...
    public LocalizeValue getText() {
        return GroovyInspectionLocalize.optimizeAllImports();
    }
    ...
    private boolean containsErrorsPreventingOptimize(GroovyFile file, Document document) {
        ...
        return !DaemonCodeAnalyzer.processHighlights(
            document,
            file.getProject(),
