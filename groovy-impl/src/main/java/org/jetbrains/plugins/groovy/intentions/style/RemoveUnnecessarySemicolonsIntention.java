...
public class RemoveUnnecessarySemicolonsIntention implements IntentionAction
{
	...
	public void invoke(@NotNull Project project, Editor editor, PsiFile file) throws IncorrectOperationException
	{
		...
		if(selectionModel.hasSelection())
		{
			...
			if(!removed)
			{
				CommonRefactoringUtil.showErrorHint(project, editor, GroovyIntentionsBundle.message("no.unnecessary.semicolons.found"), GroovyIntentionsBundle.message("remove.unnecessary.semicolons" +
						".name"), null);
			}
		}
		else
	...
	private static boolean isSemiColonUnnecessaryInClassBody(PsiElement semicolon, String text, Project project)
	{
		...
		String prefix = parent instanceof GrClassDefinition ? "class" : parent instanceof GrEnumTypeDefinition ? "enum" : parent instanceof GrInterfaceDefinition ? "interface" : parent instanceof
