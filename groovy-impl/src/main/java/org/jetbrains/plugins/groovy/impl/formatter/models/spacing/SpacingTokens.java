...
package org.jetbrains.plugins.groovy.impl.formatter.models.spacing;
...
{
	TokenSet LEFT_BRACES = TokenSet.create(GroovyTokenTypes.mLPAREN, GroovyTokenTypes.mLBRACK,
			GroovyTokenTypes.mLCURLY);
	TokenSet RIGHT_BRACES = TokenSet.create(GroovyTokenTypes.mRPAREN, GroovyTokenTypes.mRBRACK,
	...
	TokenSet PREFIXES = TokenSet.create(GroovyTokenTypes.mDEC, GroovyTokenTypes.mINC, GroovyTokenTypes.mAT,
			GroovyTokenTypes.mBNOT, GroovyTokenTypes.mLNOT);
	...
	TokenSet RELATIONAL_OPERATORS = TokenSet.create(GroovyTokenTypes.mGT, GroovyTokenTypes.mGE, GroovyTokenTypes.mLT,
			GroovyTokenTypes.mLE, GroovyTokenTypes.mCOMPARE_TO);
	TokenSet BITWISE_OPERATORS = TokenSet.create(GroovyTokenTypes.mBAND, GroovyTokenTypes.mBOR,
			GroovyTokenTypes.mBXOR);
	TokenSet ADDITIVE_OPERATORS = TokenSet.create(GroovyTokenTypes.mPLUS, GroovyTokenTypes.mMINUS);
	TokenSet MULTIPLICATIVE_OPERATORS = TokenSet.create(GroovyTokenTypes.mSTAR, GroovyTokenTypes.mDIV,
			GroovyTokenTypes.mMOD);
	TokenSet SHIFT_OPERATORS = TokenSet.create(GroovyElementTypes.COMPOSITE_LSHIFT_SIGN,
