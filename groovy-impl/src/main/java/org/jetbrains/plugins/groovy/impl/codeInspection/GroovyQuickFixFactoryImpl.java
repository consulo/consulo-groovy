...
import org.jetbrains.plugins.groovy.impl.annotator.intentions.dynamic.DynamicMethodFix;
import org.jetbrains.plugins.groovy.impl.annotator.intentions.dynamic.DynamicPropertyFix;
import org.jetbrains.plugins.groovy.impl.codeInspection.bugs.AddClassToExtendsFix;
import org.jetbrains.plugins.groovy.impl.codeInspection.bugs.AddMethodFix;
import org.jetbrains.plugins.groovy.impl.codeInspection.confusing.ReplaceWithImportFix;
import org.jetbrains.plugins.groovy.impl.codeInspection.local.RemoveUnusedGrParameterFix;
import org.jetbrains.plugins.groovy.impl.codeInspection.naming.RenameFix;
import org.jetbrains.plugins.groovy.impl.dsl.InvestigateFix;
...
public class GroovyQuickFixFactoryImpl extends GroovyQuickFixFactory {
  ...
  @Override
  public IntentionAction createCreateLocalVariableFromUsageFix(GrReferenceExpression expr,
