...
public class GrMethodMayBeStaticInspection extends BaseInspection {
  ...
  public JComponent createOptionsPanel() {
    ...
    optionsPanel.addCheckbox(GroovyInspectionBundle.message("method.may.be.static.only.private.or.final.option"),
                             "myOnlyPrivateOrFinal");
    optionsPanel.addCheckbox(GroovyInspectionBundle.message("method.may.be.static.ignore.empty.method.option"),
                             "myIgnoreEmptyMethods");
    return optionsPanel;
  }
    ...
    return new BaseInspectionVisitor() {
      ...
      public void visitMethod(GrMethod method) {
        if (checkMethod(method)) {
          final GrModifierFix modifierFix = new GrModifierFix(method, PsiModifier.STATIC, false, true,
                                                              new Function<ProblemDescriptor, PsiModifierList>() {
                                                                @Override
                                                                public PsiModifierList apply(ProblemDescriptor descriptor) {
          ...
          registerError(method.getNameIdentifierGroovy(), GroovyInspectionBundle.message("method.may.be" +
                                                                                           ".static"), new LocalQuickFix[]{modifierFix},
