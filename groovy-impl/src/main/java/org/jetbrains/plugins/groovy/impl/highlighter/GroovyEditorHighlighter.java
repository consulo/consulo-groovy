...
import org.jetbrains.plugins.groovy.impl.lang.groovydoc.highlighter.GroovyDocSyntaxHighlighter;
...
public class GroovyEditorHighlighter extends LayeredLexerEditorHighlighter
{
  ...
  private void registerGroovydocHighlighter() {
    ...
    LayerDescriptor groovyDocLayer = new LayerDescriptor(groovyDocHighlighter, "\n", GroovySyntaxHighlighter.DOC_COMMENT_CONTENT);
